...
using Practica8Unidad2.Models;

namespace Practica8Unidad2.Controllers
{
    public class InscripcionController : Controller
    {
        ...
        {
            return View(db.Inscripcions.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "Id,CursoId,EstudianteId,Semestre")] Inscripcion inscripcion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CursoId,EstudianteId,Semestre")] Inscripcion inscripcion)
        {
            if (ModelState.IsValid)
            {
